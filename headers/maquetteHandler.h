...
class MaquetteHandler : public QObject {
    ...
    private:
            ...
            const std::map <std::string, std::array<int, 8>> tracksIlluminations = {
                ...
                { "1A", { 344, 568, 151, 232, 495, 440, 192, 160 } }, //pb ici bon ok c'est fix
                { "1B", { 680, 360, 368, 96, 0, 0, 0, 0 } },
                { "3A", { 1048, 360, 695, 120, 0, 0, 0, 0 } }, //pb { "3A", { 1048, 360, 696, 120, 0, 0, 0, 0 } } FIX ????
                ...
                { "15A", { 280, 1112, 183, 456, 0, 0, 0, 0 } },
                { "15B", { 272, 800, 88, 312, 0, 0, 0, 0 } }, //pb ici fix
                ...
                { "8A", { 3104, 768, 120, 311, 2848, 600, 256, 183 } },
                { "8B", { 2608, 584, 232, 32, 0, 0, 0, 0 } },
                { "10A", { 1880, 584, 727, 16, 2224, 480, 255, 104} },
                //{ "10B", { 1464, 584, 408, 224, 1080, 808, 1736, 264 } }, //Stockage
                { "10B", { 1464, 584, 407, 224, 0,0,0,0} }, //pb { "10B", { 1464, 584, 408, 224, 0,0,0,0} }, FIX ????
                { "12A", { 856, 480, 607, 144, 568, 624, 311, 288 } }, //pb ici fix
